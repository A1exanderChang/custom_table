package com.ebs.custom_table.config;
...
@Configuration
@MapperScan(basePackages = "com.ebs.custom_table.mapper.**", sqlSessionFactoryRef = "MySQLDataBaseSessionFactory")
public class MySQLDataBaseConfig {
    @Value("${mysql.yjzhdd.url}")
    private String url;
    @Value("${mysql.yjzhdd.username}")
    private String username;
    @Value("${mysql.yjzhdd.password}")
    private String password;
    @Value("${mysql.yjzhdd.driver-class-name}")
    private String driverClassName;
    @Value("${mysql.yjzhdd.initial-size}")
    private int ininitialSize;
    @Value("${mysql.yjzhdd.min-idle}")
    private int minIdle;
    @Value("${mysql.yjzhdd.max-active}")
    private int maxActive;
    @Value("${mysql.yjzhdd.max-wati}")
    private long maxWati;
    @Value("${mysql.yjzhdd.time-between-eviction-runs-millis}")
    private long timeBetweenEvictionRunsMillis;
    @Value("${mysql.yjzhdd.min-evictable-idle-time-millis}")
    private long minEvictableIdleTimeMillis;
    @Value("${mysql.yjzhdd.validation-query}")
    private String validationQuery;
    @Value("${mysql.yjzhdd.test-while-idle}")
    private boolean testWhileIdle;
    @Value("${mysql.yjzhdd.test-on-borrow}")
    private boolean testOnBorrow;
    @Value("${mysql.yjzhdd.test-on-return}")
    private boolean testOnReturn;
    @Value("${mysql.yjzhdd.filters}")
